    ...
    <div className="relative bg-white shadow-lg sm:rounded-3xl px-4 py-10 sm:p-20">
      <div className="max-w-md mx-auto">
        <div className="divide-y divide-gray-200">
          ...
          {/* Add informational content about the system */}
          <div className="pb-6 text-center">
            <h3 className="text-xl font-semibold text-gray-900">Welcome to Your Finance Tracker</h3>
            <p className="text-gray-600 mt-2">Track your transactions, set budgets, and get insights into your spending habits with ease.</p>
